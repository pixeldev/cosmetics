...
public class AutoListenerLoader implements me.pixeldev.alya.api.loader.Loader {
  ...
  @javax.inject.Inject private me.pixeldev.ecosmetics.plugin.listener.cosmetic.PetAnimationListener petanimationlistener;
  ...
  public void load() {
    ...
    pluginManager.registerEvents(petanimationlistener, plugin);
